...
class PhysicalBookAdmin(admin.ModelAdmin):
    list_display = ['title', 'show_author', 'show_translator', 'show_category', 'publisher', 'platform', 'user_rate', 'read_flag'] 
...
class AudioBookAdmin(admin.ModelAdmin):
    list_display = ['title', 'show_author', 'show_translator', 'show_teller', 'show_category', 'publisher', 'platform', 'user_rate', 'listen_flag'] 
